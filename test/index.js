...
describe('index()', function() {
	...
	it('should load LESS and transform it to CSS', async function() {
	...
	it('should load LESS and transform it to optimized CSS when optimization enabled', async function() {
	...
	describe('.in()', function() {
		...
		it('should return a default extension', function() {
			...
			assert.strictEqual(index.in(), '.less')
